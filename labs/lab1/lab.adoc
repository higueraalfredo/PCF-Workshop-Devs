...
====
----
Using manifest file /Users/mling/workspace/PCF-Workshop-101/cf-spring-mvc-boot/manifest.yml

Creating app workshop in org Federal Workshops / space ming_test as mling@pivotal.io...
OK

Creating route workshop-juicier-asset.cfapps.io...
OK

Binding workshop-juicier-asset.cfapps.io to workshop...
